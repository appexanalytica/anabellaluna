...
const tutorialSteps = [
  ...
  },
  {
    ...
    icon: <FaComments />,
    title: 'Consultas',
    subtitle: 'Mensajes que llegan desde el sitio web',
    description: 'Todo lo que escriben los visitantes del sitio en un solo lugar: consultas sobre propiedades, solicitudes de visita y mensajes del formulario de contacto. La burbuja de mensajes de la barra superior muestra un adelanto de los últimos.',
    features: ['Consultas sobre propiedades publicadas', 'Solicitudes de visita', 'Mensajes del formulario de contacto', 'Marcado de leídas para no perder ninguna'],
    color: '#06b6d4',
    path: '/consultas',
  },
  {
