...
const GRUPOS = [
  { clave: 'propiedades', label: 'Propiedades', icono: <FaBuilding />, ruta: (id) => `/crm/propiedades?id=${id}` },
  { clave: 'clientes', label: 'Clientes', icono: <FaUser />, ruta: (id) => `/crm/clientes?id=${id}` },
  { clave: 'operaciones', label: 'Operaciones', icono: <FaHandshake />, ruta: (id) => `/crm/operaciones?id=${id}` },
];
