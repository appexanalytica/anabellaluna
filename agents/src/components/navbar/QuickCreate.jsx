 ...
 */
const ACCIONES = [
  { label: 'Propiedad', icono: <FaBuilding />, ruta: '/crm/propiedades?nuevo=1' },
  { label: 'Cliente', icono: <FaUser />, ruta: '/crm/clientes?nuevo=1' },
  { label: 'Cita', icono: <FaCalendarAlt />, ruta: '/crm/citas?nuevo=1' },
  { label: 'Tarea', icono: <FaTasks />, ruta: '/crm/citas?nuevo=tarea' },
];
