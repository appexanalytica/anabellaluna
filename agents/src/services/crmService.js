...
export const crmService = {
  ...
  activities: {
    ...
    markRead: (id, read = true) => api.patch(`/crm/activities/${encodeURIComponent(id)}/read`, { read }),
  },
  ...
  // El chat interno se elimino; solo queda el estado en linea, que usan
  // authService y App al iniciar y cerrar sesion.
  presence: {
