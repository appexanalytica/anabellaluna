...
// La generación de notificaciones del admin vive en services/notificationGenerator.js,
// compartida con la ruta POST /admin/notifications/generate para que no vuelvan a divergir.
// Se importa acá adentro para evitar un ciclo de require al arrancar.
function generateAdminNotifications() {
  // eslint-disable-next-line global-require
  return require('./notificationGenerator').generateAdminNotifications();
}
